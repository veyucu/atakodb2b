    ...
    <div class="row">
                    ...
                    <form action="{{ route('admin.settings.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            @if($settings->logo_url)
                                <div class="mb-2">
                                    <img src="{{ $settings->logo_url }}" alt="Site Logo" class="img-thumbnail" style="max-height: 100px;">
                                </div>
                            @endif
                            <input type="file" 
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    <p class="mb-2"><i class="fas fa-check text-success me-2"></i>Site adı ve logo tüm sayfalarda görünür.</p>
                    <p class="mb-2"><i class="fas fa-check text-success me-2"></i>Firma bilgileri footer'da gösterilir.</p>
