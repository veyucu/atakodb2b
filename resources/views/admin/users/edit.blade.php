                    ...
                    <form action="{{ route('admin.users.update', $user) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="il" name="il" value="{{ old('il', $user->il) }}">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="ilce" class="form-label">İlçe</label>
                                <input type="text" class="form-control" id="ilce" name="ilce" value="{{ old('ilce', $user->ilce) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="telefon" name="telefon" value="{{ old('telefon', $user->telefon) }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="mail_adresi" class="form-label">E-posta</label>
                                <input type="email" class="form-control" id="mail_adresi" name="mail_adresi" value="{{ old('mail_adresi', $user->mail_adresi) }}">
                            </div>

                            <div class="col-md-4 mb-3">
                                <label for="gln_numarasi" class="form-label">GLN Numarası</label>
                                <input type="text" class="form-control" id="gln_numarasi" name="gln_numarasi" value="{{ old('gln_numarasi', $user->gln_numarasi) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="vergi_dairesi" name="vergi_dairesi" value="{{ old('vergi_dairesi', $user->vergi_dairesi) }}">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="vergi_kimlik_numarasi" class="form-label">VKN</label>
                                <input type="text" class="form-control" id="vergi_kimlik_numarasi" name="vergi_kimlik_numarasi" value="{{ old('vergi_kimlik_numarasi', $user->vergi_kimlik_numarasi) }}">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" id="grup_kodu" name="grup_kodu" value="{{ old('grup_kodu', $user->grup_kodu) }}">
                            </div>

                            <div class="col-md-6 mb-3">
                                <label for="plasiyer_kodu" class="form-label">Plasiyer Kodu</label>
                                <input type="text" class="form-control" id="plasiyer_kodu" name="plasiyer_kodu" value="{{ old('plasiyer_kodu', $user->plasiyer_kodu) }}">
                            </div>
                        </div>
