            ...
            <div class="card border-success">
                ...
                <div class="card-body">
                    <div class="alert alert-success">
                        ...
                        <hr>
                        <p class="mb-1"><strong>Sipariş Numarası:</strong> <span class="badge bg-primary fs-5">{{ $order->order_number }}</span></p>
                        <p class="mb-1"><strong>Sipariş Tarihi:</strong> {{ $order->created_at->format('d.m.Y H:i') }}</p>
                        <p class="mb-0"><strong>Durum:</strong> {!! $order->status_badge !!}</p>
                    </div>
                    ...
                    <div class="alert alert-info mt-4">
                        <i class="fas fa-info-circle"></i> Siparişiniz başarıyla alındı. En kısa sürede işleme alınacaktır. 
