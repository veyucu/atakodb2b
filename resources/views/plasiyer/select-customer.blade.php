                        ...
                        <table class="table table-hover customers-table" id="customersTable">
                            ...
                            <tbody>
                                @foreach($customers as $customer)
                                    <tr class="customer-row" data-search="{{ mb_strtolower($customer->username . ' ' . $customer->name . ' ' . $customer->ilce . ' ' . $customer->il . ' ' . $customer->telefon, 'UTF-8') }}">
                                        ...
                                        <td class="text-center">
                                            @if($customer->cart_count > 0)
                                                <div class="small"><strong>{{ $customer->cart_item_count }} kalem</strong> / {{ $customer->cart_count }} adet</div>
                                                <div class="mt-1"><strong class="text-success small">{{ number_format($customer->cart_total, 2, ',', '.') }} ₺</strong></div>
                                            @else
